...
- [具体操作步骤](#具体操作步骤)
  - [制作启动盘](#制作启动盘)
    - [生成镜像文件](#生成镜像文件)
    - [使用rufus制作启动盘](#使用rufus制作启动盘)
    - [使用ventoy制作启动盘](#使用ventoy制作启动盘)
  - [重启电脑](#重启电脑)
  - [进入Windows安装界面](#进入windows安装界面)
- [遇到的问题](#遇到的问题)
  - [这里有三个可能的原因](#这里有三个可能的原因)
  - [解决办法](#解决办法)
- [总结](#总结)
...
插入忘记密码的那台电脑，重启电脑，按住F12（电脑品牌不同启动不同）。在当前的 **​​Boot Menu**​​ 界面中，选择U盘启动（​​USB HDD: AI Mass Storage）：
