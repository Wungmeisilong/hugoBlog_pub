...
#include <cstddef>  //作用：提供一些与类型相关的常量，如CHAR_BIT、CHAR_MAX、CHAR_MIN等
#include <cstdlib>  //作用：提供动态内存管理函数，如malloc、free、calloc、realloc等
#include <climits>  //作用：提供一些与类型相关的常量，如CHAR_BIT、CHAR_MAX、CHAR_MIN等

#include "algobase.h" //算法基础
